...
const dbSchema = DB_SCHEMA || 'genesis_development';
console.info('DB_SCHEMA:', DB_SCHEMA, `(set to: ${dbSchema})`);

const dbUser = DB_USER || 'genesis_development';
console.info('DB_USER:', DB_USER, `(set to: ${dbUser})`);

const dbPassword = DB_PASSWORD || 'genesis_development';
